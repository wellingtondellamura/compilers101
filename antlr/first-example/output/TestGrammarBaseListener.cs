...
public partial class TestGrammarBaseListener : ITestGrammarListener {
	...
	public virtual void EnterAtrib([NotNull] TestGrammarParser.AtribContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="TestGrammarParser.atrib"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAtrib([NotNull] TestGrammarParser.AtribContext context) { }
	/// <summary>
